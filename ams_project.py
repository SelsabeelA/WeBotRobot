...
Original file is located at
    https://colab.research.google.com/drive/1UI4ca3D17TuWGPm1MLu-6r5tJQlJfMdU
"""
...
def visualize_path(maze, path, delay=0.5):
    given_maze.highlight_path(path)
    print(given_maze)
    given_maze.clear_highlighted_path(path)
    time.sleep(delay)

def dfs(initial, goal_test, successors, visualize=False):
...
def bfs(initial, goal_test, successors, visualize=False):
...
def astar(initial, goal_test, successors, heuristic, visualize=False):
    frontier = []
    ...
    while frontier:
        ...
        if goal_test(current_state):
            return current_node, heuristic_info
        ...
        for child in successors(current_state):
            ...
            if child not in explored or explored[child] > new_cost:
                ...
                heuristic_value = heuristic(child)
                heuristic_info.append((child, heuristic_value))
                heappush(frontier, Node(child, current_node, new_cost, heuristic_value))

    return None, heuristic_info
...
if __name__ == "__main__":
    ...
    print("=================== DFS ==========================")
    solution1 = dfs(given_maze.start, given_maze.goal_test, given_maze.get_available_moves, visualize=True)
    ...
    print("=================== BFS ===========================")
    solution2 = bfs(given_maze.start, given_maze.goal_test, given_maze.get_available_moves, visualize=True)
    ...
    solution3, heuristic_info = astar(given_maze.start, given_maze.goal_test, given_maze.get_available_moves, distance, visualize=True)
    if solution3 is None:
        ...
        print("Heuristic Information:")
        for loc, h in heuristic_info:
            print(f"Location: {loc}, Heuristic: {h}")